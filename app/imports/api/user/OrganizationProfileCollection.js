...
class OrganizationProfileCollection extends BaseProfileCollection {
   ...
   * @param password The password for this organization.
   ...
   * Also removes this organization from Meteor Accounts.
  ...
  /**
   * Implementation of assertValidRoleForMethod. Asserts that organizationId is logged in as an Admin or Organization.
   * This is used in the define, update, and removeIt Meteor methods associated with each class.
   * @param organizationId The organizationId of the logged in organization. Can be null or undefined
   * @throws { Meteor.Error } If there is no logged in organization, or the organization is not an Admin or Organization.
   */

...
const NavBar = ({ currentUser }) => (
  <Menu className={'navbar-menu-orientation'} size='large' borderless stackable>
    ...
    {Roles.userIsInRole(Meteor.userId(), [ROLE.ADMIN]) ? (
      ...
      ([<Menu.Menu className={'organization-color'} key='org-navbar'>
        <Menu.Item as={NavLink} style={{ color: '#C179B9' }} exact to="/org-profile" key='org-profile'>
          My Profile
        </Menu.Item>
        <Menu.Item as={NavLink} exact to="/manage-opp" key='manage-opp'>
